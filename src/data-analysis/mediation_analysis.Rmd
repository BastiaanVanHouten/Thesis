...
model_summaries <- bind_rows(
  ...
  glance(model_path_b_t1_air) %>% mutate(model = "model_path_b_t1_air")  # Add model_path_b_t1_air
)
...
model_coefficients <- bind_rows(
  ...
  tidy(model_path_b_t1_air) %>% mutate(model = "model_path_b_t1_air")  # Add model_path_b_t1_air
