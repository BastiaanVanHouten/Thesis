...
subset <- subset %>%
    mutate(
        Assigned_Asian = ifelse(asian == Highest_Probability, 1, 0),
        Assigned_Black = ifelse(black == Highest_Probability, 1, 0),
        Assigned_Hispanic = ifelse(hispanic == Highest_Probability, 1, 0),
        Assigned_White = ifelse(white == Highest_Probability, 1, 0)
    )
